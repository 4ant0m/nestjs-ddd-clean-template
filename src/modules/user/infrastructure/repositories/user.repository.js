...
var user_entity_1 = require("@user/domain/entities/user.entity");
var UserRepository = /** @class */ (function () {
    function UserRepository(prisma, passwordService) {
        this.prisma = prisma;
        this.passwordService = passwordService;
    }
    UserRepository.prototype.createUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var createdUser, _a, _b, _c;
            var _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        createdUser = _f.sent();
                        return [2 /*return*/, new user_entity_1.User(createdUser)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (user) {
                            return [2 /*return*/, new user_entity_1.User(user)];
                        }
                        else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        updatedUser = _a.sent();
                        return [2 /*return*/, new user_entity_1.User(updatedUser)];
                }
            });
        });
    };
